  ...
  firebase.database().ref("Caixas").once("value",snapshot=>{
    snapshot.forEach(item =>{
      ...
      if(caixa.status == 'aberto'){
        ...
        this.pedido = new PedidoMesa(cliente,produtos, id,'0',);
...
criarCarrinho(tr,data){
  ...
  this.carrinho = new CarrinhoMesa(produto,sabor,quantidade,valor,adc,obs,);
}
              ...
              if(dat.status == 'Mesa Ocupada!'){
                ...
                tr.querySelector('.Edit').addEventListener("click",e=>{
                  ...
                  if(dat.pagamento == 'separado'){
                    ...
                    this.pedido = new PedidoMesa(cliente,pedido,0,chave);
